...
object Cle2dfine {
  ...
  def main(args: Array[String]): Unit = {
    println("2d approximate spatial CLE simulation from a reaction-diffuion Lotka-Volterra model - will run FOREVER - just kill it when you get bored!")
    val r = 80
    val c = 100
    ...
    val s = Stream.iterate(xx0)(x => step(x,0.0,0.2))
